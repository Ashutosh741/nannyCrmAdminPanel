                ...
                <div className="col-12">
                    ...
                    <div className="row receipt">
                        ...
                        <div className="col-4">
                          ...
                          <h6 className="mt-2">SECURITY DEPOSIT</h6>
                          </div>
                        </div>
                        ...
                        <div className="col-12 row-4 mb-2  d-flex ">
                            ...
                            <div className="purpose">
                                <span>PURPOSE OF : <strong>SECURITY DEPOSIT FOR AYA SERVICE</strong></span>
                            </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 row text-center mt-3 mb-5">
                            ...
                            <div className="col-6">
                                <div className="display text-start">
                                    <span className='currency fw-bold '>RS-</span>
                                   
                                    <span className='amount fw-bold'>{securityAmount}/-</span>
...
export default adminLayout(SecurityDeposit)
